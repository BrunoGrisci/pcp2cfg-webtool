...
(function () {
  const I18N = {
    en: {
      ...
      "result.aligned_legend": "Legend: green border = matching token, red border = mismatching token, · = missing token.",
    ...
    "pt-BR": {
      ...
      "result.aligned_legend": "Legenda: borda verde = token coincide, borda vermelha = token não coincide, · = token ausente.",
